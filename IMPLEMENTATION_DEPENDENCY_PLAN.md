...
- **Outputs:**
  ...
  - 8 CMS module interfaces:
    ...
    8. CRM Leads Inbox (`/admin/leads`): Read, filter, and update status of booking requests and newsletter subscribers.
...
- **Blockers:**
  - Network timeouts during large audio file uploads (>25MB).
