...
const EMPTY_SITE_SETTINGS: SiteSettings = {
  id: "default", hero_headline: "", hero_subheadline: "", hero_image_url: "",
  about_headline: "", about_body: "", about_image_url: "",
  booking_banner_title: "", booking_banner_body: "", artists_subtitle: null,
  events_subtitle: null, academy_subtitle: null, booking_subtitle: null,
...
export async function getSiteSettings(): Promise<SiteSettings> {
  try {
    ...
    return {
      ...(USE_DEMO_CONTENT ? DEFAULT_SITE_SETTINGS : EMPTY_SITE_SETTINGS),
      ...row,
      social_links:
        typeof row.social_links === "object" && row.social_links !== null
          ? (row.social_links as Record<string, string>)
          : (USE_DEMO_CONTENT ? DEFAULT_SITE_SETTINGS.social_links : {}),
    };
