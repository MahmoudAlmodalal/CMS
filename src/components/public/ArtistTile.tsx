...
export function ArtistTile({ artist, priority = false }: ArtistTileProps) {
  ...
  return (
    <Link
      ...
      className="group relative block h-[239px] w-[160px] min-w-0 shrink-0 overflow-hidden rounded-[16px] bg-[#2A1D13] focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 focus-visible:ring-offset-black m-3 sm:m-4 lg:h-[293px] lg:w-[220px]"
