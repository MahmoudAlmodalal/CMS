...
export function FeaturedArtists({ artists, heading, ctaLabel, ctaHref }: FeaturedArtistsProps) {
  ...
  return (
    <section className="w-full overflow-x-hidden bg-black pb-8 pt-8 sm:py-16 md:py-20 lg:min-h-[615px] lg:py-24">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 xl:px-16">
        ...
        <div
          className="mx-auto mt-3 grid w-full max-w-full grid-cols-2 justify-items-center gap-x-1 gap-y-2 sm:mt-7 sm:gap-x-2 sm:gap-y-3 md:grid-cols-3 md:gap-x-4 md:gap-y-4 lg:grid-cols-4 lg:gap-x-5 lg:gap-y-5 xl:grid-cols-6 [&>*:nth-child(n+5)]:hidden md:[&>*:nth-child(n+5)]:block max-[359px]:grid-cols-1"
        >
