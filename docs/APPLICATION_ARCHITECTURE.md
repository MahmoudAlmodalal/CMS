...
| `/events` | `(public)` | ISR (`revalidate = 1800`) | Public | Concerts & festival listings with category tabs. Event cards link to `/booking?event_id=[id]` or external `ticket_url`. |
...
| :--- | :---: | :--- | :--- | :--- |
| `site` | **Yes** | `image/jpeg`, `image/png`, `image/webp`, `image/svg+xml` | 5 MB | Hero banners, brand imagery, logos, OG images. |
| `artists` | **Yes** | `image/jpeg`, `image/png`, `image/webp` | 5 MB | Musician portraits, ensemble photos. |
| `releases` | **Yes** | `image/jpeg`, `image/png`, `image/webp` | 5 MB | Album covers, recording artwork. |
| `events` | **Yes** | `image/jpeg`, `image/png`, `image/webp` | 5 MB | Concert posters, festival flyers. |
| `academy` | **Yes** | `image/jpeg`, `image/png`, `image/webp` | 5 MB | Educational track thumbnails. |
| `articles` | **Yes** | `image/jpeg`, `image/png`, `image/webp` | 5 MB | Article cover images, editorial photos. |
| `audio` | **Yes** | `audio/mpeg`, `audio/ogg`, `audio/wav` | 30 MB | Musician audio player streaming samples. |
...
export async function uploadMediaAction(
  bucket: 'site' | 'artists' | 'releases' | 'events' | 'academy' | 'articles' | 'audio',
  formData: FormData
