...
--   DROP FUNCTION IF EXISTS public.has_role(TEXT[]); DROP FUNCTION IF EXISTS public.is_admin();
...
CREATE POLICY "site_settings_update_admin"
  ...
  USING (public.is_admin()) WITH CHECK (public.is_admin() AND id = 'default');
...
CREATE POLICY "artists_select_admin"
  ON artists FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "artists_insert_admin" ON artists;
CREATE POLICY "artists_insert_admin"
  ON artists FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "artists_delete_admin"
  ON artists FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "tracks_select_admin"
  ON tracks FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "tracks_insert_admin" ON tracks;
CREATE POLICY "tracks_insert_admin"
  ON tracks FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "tracks_delete_admin"
  ON tracks FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "releases_select_admin"
  ON releases FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "releases_insert_admin" ON releases;
CREATE POLICY "releases_insert_admin"
  ON releases FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "releases_delete_admin"
  ON releases FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "events_select_admin"
  ON events FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "events_insert_admin" ON events;
CREATE POLICY "events_insert_admin"
  ON events FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "events_delete_admin"
  ON events FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "academy_courses_select_admin"
  ON academy_courses FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "academy_courses_insert_admin" ON academy_courses;
CREATE POLICY "academy_courses_insert_admin"
  ON academy_courses FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "academy_courses_delete_admin"
  ON academy_courses FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "articles_select_admin"
  ON articles FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "articles_insert_admin" ON articles;
CREATE POLICY "articles_insert_admin"
  ON articles FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "articles_delete_admin"
  ON articles FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "testimonials_select_admin"
  ON testimonials FOR SELECT TO authenticated USING (public.is_admin());

DROP POLICY IF EXISTS "testimonials_insert_admin" ON testimonials;
CREATE POLICY "testimonials_insert_admin"
  ON testimonials FOR INSERT TO authenticated WITH CHECK (public.is_admin());
...
CREATE POLICY "testimonials_delete_admin"
  ON testimonials FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "booking_requests_select_admin"
  ON booking_requests FOR SELECT TO authenticated USING (public.is_admin());
...
CREATE POLICY "booking_requests_delete_admin"
  ON booking_requests FOR DELETE TO authenticated USING (public.is_admin());
...
CREATE POLICY "newsletter_subscribers_select_admin"
  ON newsletter_subscribers FOR SELECT TO authenticated USING (public.is_admin());
...
CREATE POLICY "newsletter_subscribers_delete_admin"
  ON newsletter_subscribers FOR DELETE TO authenticated USING (public.is_admin());
